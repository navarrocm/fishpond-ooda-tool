      ...
      <div style="background:var(--card-bg);padding:16px;border-radius:12px;box-shadow:var(--shadow);margin-bottom:16px;border-left:4px solid ${color};">
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
          ...
          <span style="font-size:0.8rem;color:${color};font-weight:600;">
            ${completeness.completeness >= 80 ? 'Good' : completeness.completeness >= 50 ? 'Partial' : 'Limited'}
          </span>
        </div>
      ...
      html += `
        <div style="background:var(--card-bg);padding:16px;border-radius:12px;box-shadow:var(--shadow);margin-bottom:16px;border-left:4px solid ${color};">
          ...
          <div style="display:flex;align-items:center;gap:16px;">
            ...
            <div><div style="font-weight:600;">${health.rating}</div><div style="font-size:0.8rem;color:var(--text-muted);">${health.dataCompleteness}% data available</div></div>
          </div>
          ...
          ${health.missingMetrics.length > 0 ? `
  ...
  container.innerHTML = `
    <div style="max-width:800px;margin:0 auto;">
      ...
      <div style="background:var(--card-bg);padding:16px;border-radius:12px;box-shadow:var(--shadow);margin-bottom:16px;border-left:4px solid #2ecc71;">
        ...
        <p style="margin-top:8px;"><strong>Q: What if I miss a measurement?</strong></p>
        <p>A: Just leave it blank. The app will calculate what it can with the data you have.</p>
